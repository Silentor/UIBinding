...
{
    public class ObservableBehDebug : MonoBehaviour, INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public event Action<Object, String> PropertyChanging
        {
            add
            {
                ...
                Debug.Log( $"[ObservableBehDebug]-[{GetType().Name}] PropertyChanging subscripted, count {_propertyChanging.GetInvocationList().Length}" );
            }
            remove
            {
                ...
                Debug.Log( $"[ObservableBehDebug]-[{GetType().Name}] PropertyChanging unsubscripted, count {subsCount}" );
            }
        }
        ...
        public event Action<Object, String> PropertyChanged
        {
            add
            {
                ...
                Debug.Log( $"[ObservableBehDebug]-[{GetType().Name}] PropertyChanged subscripted, count {_propertyChanged.GetInvocationList().Length}" );
            }
            remove
            {
                ...
                Debug.Log( $"[ObservableBehDebug]-[{GetType().Name}] PropertyChanged unsubscripted, count {subsCount}" );
            }
        }
        ...
        ~ObservableBehDebug( )
        {
            if(PropertyChangedCount > 0)
                Debug.LogError( $"[ObservableBehDebug]-[{GetType().Name}] PropertyChanged has {PropertyChangedCount} leaked subscribers at finalization" );
            if(PropertyChangingCount > 0)
                Debug.LogError( $"[ObservableBehDebug]-[{GetType().Name}] PropertyChanging has {PropertyChangingCount} leaked subscribers at finalization" );
        }
